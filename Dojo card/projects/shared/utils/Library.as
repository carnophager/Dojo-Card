package projects.shared.utils 
{
	...
	public class Library 
	{
		...
		public static function getClass(linkage_:String) : Class
		{
			if ( !linkage_ )
			{
				trace(getQualifiedClassName(Library) + '.getClasss() -> Warning linkage is null or empty');
			...
			{
				trace(getQualifiedClassName(Library) + '.getClass() -> Warning class with linkage ' + linkage_ + ' does not exist!');
